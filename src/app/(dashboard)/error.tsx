  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Dashboard Error</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-6">Something went wrong in the dashboard. Please try again.</p>
        <button
          onClick={reset}
